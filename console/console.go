...
func (c *Console) init(preload []string) error {
	...
	flatten := "var aux = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Gaux JavaScript console!\n\n")
	c.jsre.Run(`
		console.log("instance: " + web3.version.node);
		console.log("coinbase: " + aux.coinbase);
		console.log("at block: " + aux.blockNumber + " (" + new Date(1000 * aux.getBlock(aux.blockNumber).timestamp) + ")");
